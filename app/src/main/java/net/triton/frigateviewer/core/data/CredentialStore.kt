...
class CredentialStore
    ...
    constructor(
        ...
        suspend fun setBearer(
            serverId: String,
            jwt: String,
        ) = setPassword(serverId, BEARER_PREFIX + jwt)
         ...
         */
        suspend fun rawSecret(serverId: String): String? =
            mutex.withLock {
                withContext(Dispatchers.IO) {
        ...
        suspend fun pinnedCert(serverId: String): ByteArray? =
            withContext(Dispatchers.IO) {
